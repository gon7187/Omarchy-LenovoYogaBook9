...
camera (GREY 640x360, emitter lights without `linux-enable-ir-emitter`). The IR
emitter saturates a face at any `exposure_time_absolute`, down to `2`, so Howdy
finds no face there; face unlock was dropped. Both stream pure black frames while the hardware privacy
