...
ColumnLayout {
    ...
    RowLayout {
        Layout.fillWidth: true
        Text { text: row.label; color: "#cfdbeb"; font.pixelSize: 14; Layout.fillWidth: true }
        Text { text: row.displayValue; color: "#8dcbff"; font.pixelSize: 14; font.weight: Font.DemiBold }
    }
    RowLayout {
        ...
        Controls.Slider {
            ...
            background: Rectangle {
                ...
                width: slider.availableWidth; height: 4; radius: 2; color: "#304057"
                Rectangle { width: slider.visualPosition*parent.width; height: parent.height; radius: 2; color: "#79bfff" }
            }
            handle: Rectangle {
                x: slider.leftPadding+slider.visualPosition*(slider.availableWidth-width)
                y: slider.topPadding+slider.availableHeight/2-height/2
                width: 20; height: 20; radius: 10
                color: slider.pressed ? "#ffffff" : "#bbdfff"; border.color: "#79bfff"; border.width: 2
            }
        }
        Key { label: "+"; textSize: 21; radius: 8; repeatable: true; Layout.preferredWidth: 34; Layout.fillHeight: true; onActivated: row.change(row.step) }
    }
