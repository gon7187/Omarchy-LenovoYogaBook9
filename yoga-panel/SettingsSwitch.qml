...
RowLayout {
    ...
    Text { text: row.label; color: "#dbe6f3"; font.pixelSize: 14; Layout.fillWidth: true }
    Controls.Switch {
        id: toggle
        checked: row.checked
        ...
        indicator: Rectangle {
            ...
            color: toggle.checked ? "#548bbb" : "#304057"
            Rectangle {
                x: toggle.checked ? 25 : 3; y: 3; width: 22; height: 22; radius: 11; color: "#eef6ff"
