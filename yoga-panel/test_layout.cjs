...
const sent=[];
let now=1000;
const root=vm.createContext({languagePending:false,languageRequest:0,keyboardLanguage:"",languageGuard:{restart(){}},pad:{stopMomentum(){}},voiceSession:false,russian:true,shift:false,shiftHeld:false,shiftUsed:false,alt:false,control:false,logo:false,
