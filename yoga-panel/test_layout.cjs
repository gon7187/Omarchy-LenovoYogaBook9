...
const sent=[];
let now=1000;
const root=vm.createContext({fn:false,fnActive:false,languagePending:false,languageRequest:0,keyboardLanguage:"",languageGuard:{restart(){}},pad:{stopMomentum(){}},voiceSession:false,russian:true,shift:false,held:{},used:{},alt:false,control:false,logo:false,
