...
- Компактная верхняя строка: слова, настройки, Esc и закрытие. Язык переключается Alt+Shift.
...
- **✦ Слова** включает три офлайн-подсказки по префиксу от двух букв.
  Также предлагает исправления опечаток. Уверенное исправление применяется по пробелу;
...
Кандидаты: одна лишняя/пропущенная/неверная буква или перестановка соседних букв.
