...
- Закрыть все окна: зажать Ctrl и Alt, тапнуть ⌫ (дубль системного Ctrl+Alt+Delete,
  которого на панели нет). Закрывает окна на всех столах и возвращает на стол 1.
